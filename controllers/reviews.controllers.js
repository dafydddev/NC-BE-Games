...
exports.getAllReviews = (req, res, next) => {
  ...
  let validCategoriesPromise = Promise.resolve();
  if (category) {
    validCategoriesPromise = validateCategory(category);
  }
  validCategoriesPromise
    .then(() => selectAllReviews(sort_by, order, category))
